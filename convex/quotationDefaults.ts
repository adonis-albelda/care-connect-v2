// Duplicated from src/lib/quotationDefaults.ts — Convex's bundler only
// processes files inside convex/, so this can't be a shared import. Keep
// both copies in sync if the defaults change.
